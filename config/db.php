...
function db_pdo(): PDO
{
    ...
    $pdo = new PDO($dsn, DB_USER, DB_PASS, [
        ...
        // Run every connection (and any reconnect) in Gulf time so TIMESTAMP
        // writes/reads and the admin date filters agree. Numeric offset (UAE has
        // no DST) so it works without the MySQL tz tables loaded — important on
        // shared hosting where 'Asia/Dubai' may be unavailable.
