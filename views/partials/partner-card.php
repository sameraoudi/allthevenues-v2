 ...
 * partner_list row incl. cover_image). Cover image priority: the provider's own
 * cover, else its best published venue image → seeded gradient fallback. A type icon
