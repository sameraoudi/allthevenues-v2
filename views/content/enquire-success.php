...
/** Enquiry success content. Expects $reference (string). No PII shown. */
...
<section class="atv-enq">
  <div class="atv-wrap atv-enq__wrap">
    <div class="atv-enq__card atv-enq__success">
      ...
      <p class="atv-enq__intro">Our team will review your enquiry and be in touch shortly.</p>
      <p class="atv-enq__ref">Your reference<br><strong><?= e($reference) ?></strong></p>
      <p class="atv-enq__reassure">We've emailed you a copy for your records. Secure and confidential —
        your details are only shared with relevant venue partners.</p>
      <div class="atv-enq-nav atv-enq-nav--center">
        <a class="atv-btn" href="<?= e(base_url('venues')) ?>">Browse more venues</a>
